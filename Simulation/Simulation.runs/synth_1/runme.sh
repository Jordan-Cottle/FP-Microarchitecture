...
HD_PWD='C:/Users/jorda/Documents/Projects/FP-Microarchitecture/Simulation/Simulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FileReader.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FileReader.tcl
